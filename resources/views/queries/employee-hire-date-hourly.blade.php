...
@section('content')
        ...
        @component('components.content-title')
                ...
                @slot('title')
                Query: Employee Hire Date - Hourly
                @endslot
                ...
                @slot('exportRoute')
                @if(isset($employees))
                {{Route('export-employee-hire-date-hourly', ['start_date' => $startDate->format('m/d/Y'), 'end_date' => $endDate->format('m/d/Y')])}}
                @endif
                @endslot
        @endcomponent
        ...
        <form action="{{Route('queries.employee-hire-date-hourly')}}" class="mt-2" id="search-employee-hire-date-hourly-form" method="GET" autocomplete="off">
            @csrf
