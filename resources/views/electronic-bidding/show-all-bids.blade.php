            ...
            <div class="card bid-card shadow mb-1 mt-2">
                ...
                <div class="card-body py-2">
                    ...
                    <div class="input-group input-group-sm mb-2">
                        ...
                        <input type="text" class="form-control font-weight-bold bid-card-input" value="{{$bid->post_date->format('m/d/Y')}}"
                            disabled>
                    </div>
                    <div class="input-group input-group-sm mb-2">
                        <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control font-weight-bold bid-card-input" value="{{$bid->pull_date->format('m/d/Y')}}"
                            disabled>
                    </div>
                    <div class="input-group input-group-sm mb-2">
                        <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control font-weight-bold bid-card-input" value="{{$bid->team->description}}"
                            disabled>
                    </div>
                    <div class="input-group input-group-sm mb-2">
                        <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control font-weight-bold bid-card-input" value="{{$bid->position->description}}"
                            disabled>
                    </div>
                    <div class="input-group input-group-sm mb-2">
                        <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control font-weight-bold bid-card-input" value="{{$bid->shift->description}}"
                            disabled>
                    </div>
                    <div class="input-group input-group-sm mb-2">
                        <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control font-weight-bold bid-card-input" value="{{$bid->number_of_openings}}"
                            disabled>
                    </div>
                </div>
            </div>
