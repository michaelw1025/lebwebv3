        ...
        <form action="{{Route('costCenters.update', $costCenter->id)}}" class="mt-2" id="edit-cost-center-form" method="POST" autocomplete="off">
            ...
            <div class="form-row mt-4">
                <div class="form-group col-md-6 col-lg-4">
                    ...
                    <input type="text" class="form-control {{$errors->has('number') ? 'is-invalid' : ''}}" id="edit-cost-center-number" name="number" value="{{old('number') ? old('number') : $costCenter->number}}" required>
                ...
                <div class="form-group col-md-6 col-lg-4">
                    ...
                    <input type="text" class="form-control {{$errors->has('description') ? 'is-invalid' : ''}}" id="edit-cost-center-description" name="description" value="{{old('description') ? old('description') : $costCenter->description}}" required>
                ...
                <div class="form-group col-md-6 col-lg-4">
                    ...
                    <select class="custom-select {{$errors->has('staff_manager') ? 'is-invalid' : ''}}" id="edit-cost-center-staff-manager" name="staff_manager" required>
                ...
                <div class="form-group col-md-6 col-lg-4">
                    ...
                    <select class="custom-select {{$errors->has('day_team_manager') ? 'is-invalid' : ''}}" id="edit-cost-center-day-team-manager" name="day_team_manager" required>
                ...
                <div class="form-group col-md-6 col-lg-4">
                    ...
                    <select class="custom-select {{$errors->has('night_team_manager') ? 'is-invalid' : ''}}" id="edit-cost-center-night-team-manager" name="night_team_manager" required>
                ...
                <div class="form-group col-md-6 col-lg-4">
                    ...
                    <select class="custom-select {{$errors->has('day_team_leader') ? 'is-invalid' : ''}}" id="edit-cost-center-day-team-leader" name="day_team_leader" required>
                ...
                <div class="form-group col-md-6 col-lg-4">
                    ...
                    <select class="custom-select {{$errors->has('night_team_leader') ? 'is-invalid' : ''}}" id="edit-cost-center-night-team-leader" name="night_team_leader" required>
